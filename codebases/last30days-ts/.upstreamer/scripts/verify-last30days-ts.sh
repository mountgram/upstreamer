...
check_grep "searchWeather" "Weather source SDK"
check_grep "Open-Meteo" "Weather/Open-Meteo documentation"
...
check_regex "Source Map|source map|source access|Direct source" "source-purpose/source-access guidance"
